...
public static String prevLastCommandCode = "";
 ...
 **************************************************************************************************************************/
void draw() {
  if(prevLastCommandCode != lastCommandCode){
    client.publish("robot1/start", lastCommandCode);
  }
  prevLastCommandCode = lastCommandCode;
